...
namespace A3TelegramBot.Domain.AggregateModels.UserSessionAggregate.UserSessionEntity;
...
public sealed class UserSession:EntityBase, IAggregateRoot
{
    ...
    public void CompleteCallbackProcess()
    {
        CurrentState = UserSessionState.Idle;
        LastActivity = DateTime.UtcNow;
        RegisterDomainEvent(new CallBackRequestCompletedEvent());
    }
    ...
    public void CompleteSearchNearestReceptionsProcess()
    {
        CurrentState = UserSessionState.Idle;
        LastActivity = DateTime.UtcNow;
        RegisterDomainEvent(new SearchNearestReceptionsCompletedEvent());
    }
